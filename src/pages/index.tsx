...
GlobalWorkerOptions.workerSrc = 'https://npmcdn.com/pdfjs-dist@2.5.207/build/pdf.worker.js'
    ...
    const onDropHandler = (event: React.DragEvent<HTMLDivElement>) => {
        ...
        Promise.all(
            files.map(async (file) => {
                ...
                const pages = await documentToExport.copyPages(pdfDoc, pdfDoc.getPageIndices())
    ...
    return (
        <div
            ...
            {pages.length !== 0 ? (
                <>
                    <button
                        className="z-50 fixed rounded-lg text-white font-bold text-xl bottom-10 shadow-xl right-10 py-10 px-16 bg-gradient-to-r from-indigo-500 to-blue-500"
